...
这些能被动态规划求解的问题的特点是，其问题的最优解是由数个小问题的最优解构成，可以通过寻找子问题的最优解来得到复杂问题的最优解；而子问题再复杂问题内重复出现，使得子问题的解可以被储存起来重复利用。
...
本章介绍如何用动态规划的思想来求解在马尔可夫决策过程中的最优策略。动态规划**假设知道MDP的全部参数**，如已知状态转移概率和奖励[3]。
