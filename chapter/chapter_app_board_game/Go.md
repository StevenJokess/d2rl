...
![一局围棋棋谱（图中实心圆表示黑棋的棋子， 心圆表示白棋的棋子，圆里的数记录棋子是在第几步被放在棋盘上，本图片改编自论文 D. Silver, et al. Mastering the game ofGo without human knowledge, Nature, 2017）](../../img/Go_record.png)
