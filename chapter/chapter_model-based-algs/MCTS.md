 ...
 * @LastEditTime: 2023-03-29 23:16:23
 * @Description:
...
所需搜索的节点的数目跟深度成指数增长，因此全宽度树对于大尺度空间的搜索几乎不可行。既然全宽度树无法解决问题，那么能不能构造一种非全宽度树呢？
...
> 1. https://chat.openai.com ; Prompt:Monta Carlo rollout
